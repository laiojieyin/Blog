...
$('form.commentEditForm').submit(function (e) {
  ...
  comment = $(e.currentTarget).find('[name="content"]').val(); // console.log(commentt)
...
deleteComment = function deleteComment(e) {
  var result = confirm('do you want to delete comment?');
...
__webpack_require__(/*! /Users/Brian/newblog/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/Brian/newblog/resources/sass/app.scss */"./resources/sass/app.scss");
